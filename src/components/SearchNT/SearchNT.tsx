...
import {hideSearchNT} from "../Slices/SearchModalSlices";
...
const SearchNT: React.FC<any> = () => {
     const [validated, setValidated] = useState(false);
    const { showSearchNTForm } = useSelector((state: RootState) => state.searchDataModalReducer);
 ...
 const handleSubmit = async(e: any) => {
  ...
  return (
      <>
         <Modal show={showSearchNTForm} onHide={handleClose} size={"xl"}>
               <Form
