...
import {hideSearchContrat} from "../Slices/SearchModalSlices";
...
const SearchContratAV: React.FC<any> = () => {
     const [validated, setValidated] = useState(false);
    const { showSearchContratForm } = useSelector((state: RootState) => state.searchDataModalReducer);
 ...
 const handleSubmit = async(e: any) => {
  ...
  return (
      <>
         <Modal show={showSearchContratForm} onHide={handleClose} size={"xl"}>
               <Form
...
export default SearchContratAV;
