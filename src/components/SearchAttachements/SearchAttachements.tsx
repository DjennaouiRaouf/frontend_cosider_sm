...
import {hideSearchBL} from "../Slices/SearchModalSlices";
...
const SearchAttachements: React.FC<any> = () => {
    ...
    const { showSearchBLForm } = useSelector((state: RootState) => state.searchDataModalReducer);
 ...
 const handleSubmit = async(e: any) => {
  ...
  return (
      <>
         <Modal show={showSearchBLForm} onHide={handleClose} size={"xl"}>
               <Form
