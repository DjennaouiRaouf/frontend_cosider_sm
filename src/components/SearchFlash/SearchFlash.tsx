...
import {hideSearchFlash} from "../Slices/SearchModalSlices";
...
const SearchFlash: React.FC<any> = () => {
     const [validated, setValidated] = useState(false);
    const { showSearchFlashForm } = useSelector((state: RootState) => state.searchDataModalReducer);
 ...
 const opt:any[] = [
    ...
    const getFields = async() => {
        await axios.get(`${process.env.REACT_APP_API_BASE_URL}/forms/flashfilterfields/`,{
 ...
 const handleSubmit = async(e: any) => {
  ...
  return (
      <>
         <Modal show={showSearchFlashForm} onHide={handleClose} size={"xl"}>
               <Form
                      noValidate validated={validated} onSubmit={handleSubmit} >
        <Modal.Header closeButton>
          <Modal.Title>Rechercher un Flash </Modal.Title>
        </Modal.Header>
           <Modal.Body>
