...
import {hideAddCaution} from "../Slices/AddModalSlices";
...
const AddCaution: React.FC<AddCautionProps> = ({refresh}) => {
     const [validated, setValidated] = useState(false);
    const { showAddCautionForm } = useSelector((state: RootState) => state.addDataModalReducer);
 ...
 const handleSubmit = async(e: any) => {
  ...
  return (
      <>
         <Modal show={showAddCautionForm} onHide={handleClose} size={"xl"}>
              <Form
                      noValidate validated={validated} onSubmit={handleSubmit} >
        <Modal.Header closeButton>
          <Modal.Title>Ajouter une Caution</Modal.Title>
        </Modal.Header>
                  <Modal.Body>
