...
import {hideSearchCreance} from "../Slices/SearchModalSlices";
...
const SearchCreance: React.FC<any> = () => {
     const [validated, setValidated] = useState(false);
    const { showSearchCreanceForm } = useSelector((state: RootState) => state.searchDataModalReducer);
 ...
 const handleSubmit = async(e: any) => {
  ...
  return (
      <>
         <Modal show={showSearchCreanceForm} onHide={handleClose} size={"xl"}>
               <Form
                      noValidate validated={validated} onSubmit={handleSubmit} >
        <Modal.Header closeButton>
          <Modal.Title>Rechercher une Creance </Modal.Title>
        </Modal.Header>
           <Modal.Body>
