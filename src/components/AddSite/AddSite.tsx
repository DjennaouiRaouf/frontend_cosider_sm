...
import {hideAddSite} from "../Slices/AddModalSlices";
...
const AddSite: React.FC<AddCautionProps> = ({refresh}) => {
     const [validated, setValidated] = useState(false);
    const { showAddSiteForm } = useSelector((state: RootState) => state.addDataModalReducer);
    ...
    const getState = async() => {
         ...
         await axios.get(`${process.env.REACT_APP_API_BASE_URL}/forms/sitefieldsstate/`,{
 ...
 const handleSubmit = async(e: any) => {
        ...
        if (form.checkValidity()) {
            ...
            await axios.post(`${process.env.REACT_APP_API_BASE_URL}/sm/addsite/`,Transform(formDataObject),{
                headers: {
                    Authorization: `Token ${Cookies.get("token")}`,
                    'Content-Type': 'application/json',
  ...
  return (
      <>
         <Modal show={showAddSiteForm} onHide={handleClose} size={"xl"}>
              <Form
