...
import {hideSearchRev, showSearchRev} from "../Slices/SearchModalSlices";
...
const SearchRev: React.FC<any> = () => {
     const [validated, setValidated] = useState(false);
    const { showSearchRevForm } = useSelector((state: RootState) => state.searchDataModalReducer);
 ...
 const opt:any[] = [
    ...
    const getFields = async() => {
        await axios.get(`${process.env.REACT_APP_API_BASE_URL}/forms/revfilterfields/`,{
 ...
 const handleSubmit = async(e: any) => {
  ...
  return (
      <>
         <Modal show={showSearchRevForm} onHide={handleClose} size={"xl"}>
               <Form
                      noValidate validated={validated} onSubmit={handleSubmit} >
        <Modal.Header closeButton>
          <Modal.Title>Rechercher une Revision  </Modal.Title>
        </Modal.Header>
           <Modal.Body>
