...
import {hideAddAvance} from "../Slices/AddModalSlices";
...
const AddAvance: React.FC<AddAvanceProps> = ({refresh}) => {
     const [validated, setValidated] = useState(false);
    const { showAddAvanceForm } = useSelector((state: RootState) => state.addDataModalReducer);
 ...
 const handleSubmit = async(e: any) => {
        ...
        if (form.checkValidity()) {
            ...
            await axios.post(`${process.env.REACT_APP_API_BASE_URL}/sm/addavance/`,Transform(formDataObject),{
                headers: {
                    Authorization: `Token ${Cookies.get("token")}`,
                    'Content-Type': 'application/json',
  ...
  return (
      <>
         <Modal show={showAddAvanceForm} onHide={handleClose} size={"xl"}>
              <Form
                      noValidate validated={validated} onSubmit={handleSubmit} >
        <Modal.Header closeButton>
          <Modal.Title>Ajouter une Avance</Modal.Title>
        </Modal.Header>
                  <Modal.Body>
