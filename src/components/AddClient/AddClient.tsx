...
const AddClient: React.FC<AddClientProps> = ({refresh}) => {
 ...
 const getState = async() => {
        await axios.get(`${process.env.REACT_APP_API_BASE_URL}/forms/clientfieldsstate/`,{
 ...
 const handleSubmit = async(e: any) => {
        ...
        if (form.checkValidity()) {
            ...
            await axios.post(`${process.env.REACT_APP_API_BASE_URL}/sm/addclient/`,Transform(formData),{
                headers: {
                    Authorization: `Token ${Cookies.get("token")}`,
                    'Content-Type': 'application/json',
