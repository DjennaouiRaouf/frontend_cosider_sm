...
const EncaissementsRG: React.FC<any> = () => {
    ...
    const getData = async (url: string) => {
        ...
        await axios.get(`${process.env.REACT_APP_API_BASE_URL}/sm/encrg/?nt=${ntid}&code_site=${pid}${url.replace('?', "&")}`, {
            headers: {
    ...
    const getFields = async () => {
        await axios.get(`${process.env.REACT_APP_API_BASE_URL}/forms/ergfields/?flag=l`, {
            headers: {
                'Content-Type': 'application/json',
                      ...
                      <div className="container-fluid">
                          <div className="card shadow">
                              <div className="card-header py-3">
                                  <p className="text-primary m-0 fw-bold">Encaissements De La RG Dont Le NT N° {nt} Le Pole N° {pole} </p>
                              </div>
...
export default EncaissementsRG;
